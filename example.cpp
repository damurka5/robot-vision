...
float min_depth = 100.0; //minimum distance the setup can measure (in cm)
float depth_thresh = 30.0; // Threshold for SAFE distance (in cm)
...
int main()
{
    ...
    while (true) {
        string path1 = "../resources/middle_pic.jpeg";
        string path2 = "../resources/right_pic.jpg";
